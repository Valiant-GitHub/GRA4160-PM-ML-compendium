...
**Stub path:** `course_materials/Exercises and solutions(VHL)/03_Predicting_house_prices.ipynb`
**Solution path:** `course_materials/Exercises and solutions(VHL)/03_Predicting_house_prices_VHL.ipynb`
